...
![Model Comparison](modelcomp.png)
...
![CV vs Holdout](cvmeanandholdout.png)
...
* Recall was very low (~52%), meaning many churn customers were missed.
* High accuracy here mainly comes from predicting the majority class (non-churn).

### XGBoost

* Powerful model but slightly worse ROC-AUC than Logistic Regression.
* Performance was good but not best for this dataset size.
* Linear boundary works better for this churn dataset.
